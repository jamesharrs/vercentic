...
const FEATURE_CATALOGUE = [
  ...
  { key:'portal_builder',        name:'Portal Builder',          description:'Build branded career sites, HM portals, agency portals and onboarding experiences.',    icon:'monitor',       category:'Candidate Experience',  min_plan:'foundation',    is_core:false },
  ...
  { key:'interview_management',  name:'Interview Management',    description:'Calendly-style interview scheduling, types, availability and scorecards.',              icon:'calendar',      category:'Recruitment',           min_plan:'foundation',    is_core:false },
  ...
  { key:'forms',                 name:'Forms Builder',           description:'Create custom forms for screening, surveys and confidential data.',                    icon:'clipboard',     category:'Data',                  min_plan:'foundation',    is_core:false },
