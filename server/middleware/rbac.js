...
const GLOBAL_ACTIONS = [
  ...
  // ── Companies ───────────────────────────────────────────────────────────────
  'access_companies',
  'company_research',           // run enrichment — metered, gate deliberately
  'company_infer_org',          // generate suggested reporting lines
  'company_manage_aliases',     // aliases, merges, the resolution queue
  'company_view_intel',         // talent flow, alumni, compensation bands
  'company_manage_off_limits',  // set or clear off-limits status
];
...
function seedDefaultPermissions(store) {
  ...
  const roleDefaults = {
    // NOTE: this block rebuilds super_admin from scratch on every boot, wiping
